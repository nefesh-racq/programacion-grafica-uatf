...
namespace practica3
{
    public partial class Form1 : Form
    {
        ...
        private void simpleOpenGlControl1_Paint(object sender, PaintEventArgs e)
        {
            ...
            Random r = new Random();
            for (int i = 0; i < 30; i++)
                circunferenciaEcuacion(r.Next(50, 200), r.Next(-1000, 1000), r.Next(-1000, 1000), new Color((float)r.NextDouble(), (float)r.NextDouble(), (float)r.NextDouble()), new Color((float)r.NextDouble(), (float)r.NextDouble(), (float)r.NextDouble()));
            
            //circunferenciaEcuacion(500, 30, 30, new Color(1.0f, 1.0f, 0.0f), new Color(0.0f, 0.0f, 0.0f));
            //circunferenciaEcuacion(300, 400, 100, new Color(1.0f, 1.0f, 1.0f), new Color(0.0f, 0.0f, 0.0f));
